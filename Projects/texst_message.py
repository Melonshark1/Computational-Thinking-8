...
input ("")
print (f"ones {name2} was wandering around {place} and stumbled upon {thing} they did {action} and they felt {feel}")
input ("")
print ("the end!!!!!!!!")