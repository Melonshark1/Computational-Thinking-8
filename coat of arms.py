...
# Section 2 - Your code
set_background("fall")
#make a block of your color in the background
...
s1 = create_sprite("images", 100, 100)
s2 = create_sprite("otter", -100, -100)
s8 = create_sprite("images (1)", -100, 100)
s7 = create_sprite("download", 100, -100)
# prints your message/name
message1 = create_sprite("alien",-200,200)
message1.color("red")
message1.write("quinn",font = ("Arial", 40, "normal"))
message1.hideturtle()
